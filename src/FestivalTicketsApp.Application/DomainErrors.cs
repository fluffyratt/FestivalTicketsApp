...
public static class DomainErrors
{
    ...
    public static readonly Error TicketTypeMappingMismatchHall = new(nameof(TicketTypeMappingMismatchHall));

    public static readonly Error UserEmailNotUnique = new(nameof(UserEmailNotUnique));

    public static readonly Error UserPhoneNotUnique = new(nameof(UserPhoneNotUnique));

    public static readonly Error UserSubjectNotUnique = new(nameof(UserSubjectNotUnique));
}
