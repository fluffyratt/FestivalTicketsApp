...
{
    private static readonly List<TicketStatus> TicketStatuses = 
    [
    ...
    private static readonly List<TicketType> TicketTypes =
    [
    ...
    private static readonly List<EventStatus> EventStatuses = 
    [
        new() { Status = "Planned" },
        new() { Status = "Ended" }
    ];

    private static readonly List<EventType> EventTypes = 
    [
    ...
    private static readonly List<EventGenre> EventGenres = 
    [
    ...
    private static readonly List<EventDetails> EventDetails = 
    [
        new() 
        { 
    ...
    private static readonly List<HostDetails> HostDetails = 
    [
    ...
    private static readonly List<HostType> HostTypes = 
    [
        new() { Name = "Theatre" },
    ...
    [
        ...
        { 
            ...
            Phone = "+380950000001",
            Subject = "62f8d6a0-1fce-4cc9-a6be-4c486ee92522"
        },
        new()
        {
            ...
            Phone = "+380950000002",
            Subject = "52f16653-5583-4e40-b4e9-42ad6064d482"
        }
    ];
